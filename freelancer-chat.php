...
// Fetch clients this freelancer can chat with (those they applied to)
$conv_query = "SELECT DISTINCT u.user_id, u.full_name, u.role, cp.company_name 
               FROM users u 
...
$pageTitle = 'Chat with Clients - SkillBridge';
...
<nav class="admin-navbar">
    <div class="navbar-content">
        <div class="navbar-links">
            ...
            <a href="proposal-stats.php" class="navbar-link">Proposals</a>
            <a href="freelancer-chat.php" class="navbar-link active">Chat</a>
                ...
                <div style="display: flex; flex-direction: column; gap: 10px;">
                    <?php if ($conversations->num_rows > 0): ?>
                        <?php while ($conv = $conversations->fetch_assoc()): ?>
                            <a href="freelancer-chat.php?user_id=<?php echo $conv['user_id']; ?>"
                                ...
                                <div style="flex: 1; min-width: 0;">
                                    <p style="font-weight: 600; margin: 0; font-size: 0.95rem; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;"><?php echo htmlspecialchars($conv['company_name'] ?? $conv['full_name']); ?></p>
                ...
                <?php if ($other_user_id): ?>
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; padding: 15px 20px; border-bottom: 1px solid var(--gray-200);">
                        <div style="display: flex; align-items: center; gap: 15px;">
                            ...
                            <div>
                                ...
                                <p style="color: var(--gray-600); margin: 0; font-size: 0.85rem;"><i class="fas fa-briefcase" style="margin-right: 0.5rem;"></i>Client</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="chatBox" style="flex: 1; overflow-y: auto; padding: 20px; display: flex; flex-direction: column; gap: 15px;">
                        <?php if ($messages && $messages->num_rows > 0): ?>
                            ...
                            <?php endwhile; ?>
                        <?php else: ?>
                            <div style="text-align: center; color: var(--gray-500); margin-top: 5rem;">No messages yet.</div>
                        <?php endif; ?>
                    </div>

                    <!-- Message Input -->
                    <div style="padding: 20px; border-top: 1px solid var(--gray-200);">
                        <form action="freelancer-chat.php?user_id=<?php echo $other_user_id; ?>" method="post" style="display: flex; gap: 1rem;">
